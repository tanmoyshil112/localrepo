...
Where it's used
Flexbox
Navbar, category panel, deal boxes, product rows
CSS Grid
Image grids inside deal boxes
position: relative / absolute
Layering deal boxes over the hero section, sponsored label placement
z-index
Controlling stack order between the hero fade and the boxes above it
::after pseudo-element
Gradient fade effect at the bottom of the hero image
overflow-x: auto + flex-shrink: 0
Horizontally scrollable product carousels
object-fit: contain
Preserving image aspect ratio inside fixed-size containers
-webkit-line-clamp
Truncating long product titles to two lines
...
Author
Built as a self-driven front-end practice project.